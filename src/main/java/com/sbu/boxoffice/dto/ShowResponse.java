...
public class ShowResponse {
    ...
    public String toString() {
        return "ShowResponse [showId=" + showId + ", movieTitle=" + movieTitle + ", cinemaName=" + cinemaName
                + ", screenName=" + screenName + ", start=" + start + ", end=" + end + "]";
    }
